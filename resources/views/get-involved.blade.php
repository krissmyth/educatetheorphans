    ...
    <div class="absolute inset-0">
        <div class="mx-auto max-w-6xl px-4 h-full flex items-end pb-12">
            <div class="max-w-2xl text-white">
                <h1 class="text-3xl sm:text-5xl font-bold leading-tight">Get Involved</h1>
                <p class="mt-3 text-base sm:text-lg text-gray-200">Join us in transforming lives through education, care, and community support.</p>
            </div>
        </div>
    </div>
</section>
